 ...
 */
//#define ADAPTIVE_STEP_SMOOTHING // TODO: Turn back on once it works again (https://github.com/MarlinFirmware/Marlin/issues/23958)
...
#define LIN_ADVANCE
  ...
  #else
    // Value aquired from https://marlinfw.org/tools/lin_advance/k-factor.html with changes (copied from Cura):
    // - Nozzle Temperatur: 215
    // - Retraction Distance: 6.5
    // - Bed Size X & Y: 235
    // - Retract Speed: 25
    // - Acceleration: 1000 (check with M503 for Max Acceleration X & Y)
    // - Use Bed Leveling: G29
    // At 215°C i can hear/see the extruder skipping/grinding on the filament starting at at 0.65, so don't go over it
    // Save with M900 0.55 and M500
    // 3DJake EcoPLA Black = 0.55
    // 3DJake EcoPLA White = 1.00
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define E0_CURRENT      650 // TODO: Consider increasing to 700mA (stock extruder should be able to handle ~700-750mA), might help when extuding faster
