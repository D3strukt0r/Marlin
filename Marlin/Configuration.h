...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  27.4179
    #define DEFAULT_Ki   2.1156
    #define DEFAULT_Kd  88.8339
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 131.7040
  #define DEFAULT_bedKi  24.9439
  #define DEFAULT_bedKd 463.5981
